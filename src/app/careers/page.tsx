...
export const metadata: Metadata = {
  title: "Careers",
  description:
    "Join Pedumo. We're building a remote-first software engineering team that treats craft, integrity and long-term partnerships seriously.",
...
const careersSchema = {
  ...
  mainEntity: {
    ...
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Pedumo Careers",
      itemListElement: careers.map((role) => ({
        "@type": "JobPosting",
        title: role.title,
