      ...
      <PageHero
        ...
        title={
          <>
            ...
            <span className="gradient-text font-medium">It&apos;s the posture.</span>
          </>
        }
            ...
            <div key={s.title} className="grid gap-10 py-14 sm:py-16 lg:grid-cols-[1fr_1.5fr] lg:gap-16">
              <Reveal>
                <div className="lg:sticky lg:top-32">
                  ...
                  <h2 className="mt-5 font-display text-3xl font-semibold leading-tight tracking-[-0.01em] sm:text-4xl">
                    {s.title}
                  </h2>
