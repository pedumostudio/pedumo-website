          ...
          {openSourceProjects.map((p, i) => (
            <Reveal key={p.name} delay={(i % 2) * 0.06}>
              <a
                ...
                className="group block h-full rounded-2xl border border-[var(--border)] bg-[var(--card)] p-6 transition-all duration-300 hover:border-brand-500/40 hover:shadow-[0_20px_50px_-30px_rgba(33,64,232,0.6)]"
              >
