      ...
      <PageHero
        ...
        title={
          <>
            ...
            <span className="gradient-text font-medium">outcome-based</span>
          </>
        }
            ...
            <Reveal key={t.name} delay={i * 0.06}>
              <div
                className={
                  ...
                  (t.featured
                    ? "border-brand-500/50 bg-gradient-to-b from-brand-600/10 to-transparent shadow-[0_40px_100px_-40px_rgba(33,64,232,0.45)]"
