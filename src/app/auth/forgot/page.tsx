          ...
          <Reveal>
            <div className="rounded-3xl border border-[var(--border)] bg-[var(--card)] p-7">
              ...
              <input
                ...
                type="email"
                required
                className="h-11 w-full rounded-xl border border-[var(--border)] bg-[var(--background-subtle)] px-4 text-sm outline-none focus-visible:border-brand-500 focus-visible:ring-2 focus-visible:ring-brand-500/35"
