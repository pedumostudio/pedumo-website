...
export default function HomePage() {
  return (
    <>
      ...
      <Section id="trust">
        <Reveal>
          <div className="relative overflow-hidden rounded-4xl border border-[var(--border-strong)] bg-[#05070f] px-6 py-14 sm:px-12 sm:py-16">
            <div
              aria-hidden
            ...
            <div className="relative">
              ...
              <div className="mt-12 grid gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/10 sm:grid-cols-2 lg:grid-cols-3">
                {trustPillars.map((pillar, i) => (
                  <div
                    key={pillar.title}
                    className="group relative bg-white/[0.02] p-6 transition-colors hover:bg-white/[0.05]"
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className="inline-grid h-8 w-8 place-items-center rounded-lg border border-white/10 bg-white/[0.04] text-accent-400"
                        aria-hidden
                      >
          ...
          {caseStudies.slice(0, 2).map((cs, i) => (
            <Reveal key={cs.slug} delay={(i % 2) * 0.08}>
              <Link
                ...
                className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-[var(--border)] bg-[var(--card)] p-8 transition-all duration-300 hover:border-brand-500/40 hover:shadow-[0_30px_70px_-40px_rgba(33,64,232,0.5)]"
              >
                <div
                  aria-hidden
        ...
        <div className="grid items-stretch gap-12 lg:grid-cols-[48fr_52fr] lg:gap-16">
          <Reveal className="order-2 lg:order-1">
            <div className="group relative mx-auto w-full max-w-xl lg:mx-0">
              ...
              <div
                aria-hidden
                className="absolute -inset-1 rounded-3xl opacity-60 blur-[2px] transition-opacity duration-500 group-hover:opacity-90"
                style={{
                  background:
                    "conic-gradient(from 0deg, rgba(33,64,232,0.55), rgba(47,225,193,0.55), rgba(33,64,232,0.55))",
                  animation: "spin-slow 14s linear infinite",
                }}
              />
              <div className="relative overflow-hidden rounded-3xl border border-[var(--border-strong)] shadow-[0_60px_140px_-50px_rgba(33,64,232,0.45)] transition-transform duration-500 group-hover:-translate-y-1">
                {/* Mono frame label */}
              ...
              <div className="relative aspect-[3/2] w-full sm:aspect-[4/3] lg:aspect-square">
                <Image
                  src={FOUNDER_IMAGE}
          ...
          <Reveal delay={0.1} className="order-1 flex flex-col justify-center lg:order-2">
            ...
            <h2 className="mt-4 text-balance font-display text-4xl font-semibold leading-[1.08] tracking-[-0.01em] sm:text-5xl md:text-[3.25rem]">
              Engineering leadership
              <br className="hidden sm:block" /> you can put in the room.
            </h2>
            <blockquote className="mt-7 border-l-2 border-brand-500 pl-6 text-xl font-medium leading-relaxed text-[var(--foreground)] sm:text-2xl">
              ...
              <Reveal>
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        "radial-gradient(ellipse 60% 50% at 100% 0%, rgba(33,64,232,0.22), transparent 60%)",
                    }}
                  />
                  ...
                  <h3 className="relative mt-5 text-balance font-display text-3xl font-semibold leading-[1.1] tracking-[-0.01em] text-[var(--foreground)] transition-colors group-hover:text-brand-500 sm:text-4xl md:text-[2.75rem]">
                    {featured.title}
                  </h3>
