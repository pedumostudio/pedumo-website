        ...
        <div className="grid gap-12 lg:grid-cols-[1.4fr_2fr]">
          <div className="max-w-sm">
            ...
            <p className="mt-4 text-sm leading-relaxed text-[var(--muted)]">
              {siteConfig.tagline} Pedumo engineers modern software, automation and
              security for organizations that value a trustworthy long-term partner.
            </p>
            <div className="mt-6">
              <p className="mb-3 text-xs font-medium uppercase tracking-wider text-[var(--muted)]">
                Engineering notes, no noise
              </p>
              <NewsletterForm />
            </div>
            <div className="mt-6 flex items-center gap-2">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="inline-grid h-9 w-9 place-items-center rounded-full border border-[var(--border)] text-[var(--muted)] transition-colors hover:border-brand-500/40 hover:text-brand-500"
                >
