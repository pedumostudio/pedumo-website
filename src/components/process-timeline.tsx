              ...
              >
                <span
                  className={cn(
                    ...
                    active === i
                      ? "border-brand-500 bg-brand-500 shadow-[0_0_0_4px_rgba(33,64,232,0.18)]"
            ...
            <Reveal>
              <div className="relative pl-10 sm:pl-14">
                ...
                <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1">
                  ...
                  <h4 className="font-display text-3xl font-semibold leading-tight tracking-[-0.01em] sm:text-4xl">
                    {step.title}
                  </h4>
                </div>
