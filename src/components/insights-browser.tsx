        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="h-10 w-full rounded-full border border-[var(--border)] bg-[var(--background-subtle)] pl-9 pr-4 text-sm outline-none transition-colors placeholder:text-[var(--muted)] focus-visible:border-brand-500 focus-visible:ring-2 focus-visible:ring-brand-500/35 sm:w-64"
            />
          </div>
          <a
            href="/blog/rss.xml"
      ...
      {category === "All" && !query && (
        <Reveal className="mb-12">
          ...
          >
            ...
            <h2 className="relative mt-4 text-balance font-display text-3xl font-semibold leading-[1.1] tracking-[-0.01em] sm:text-4xl md:text-[2.75rem]">
              {featured.title}
            </h2>
