...
const inputClass =
  "h-11 w-full rounded-xl border border-[var(--border)] bg-[var(--background-subtle)] px-4 text-sm text-[var(--foreground)] outline-none transition-colors placeholder:text-[var(--muted)] focus-visible:border-brand-500 focus-visible:ring-2 focus-visible:ring-brand-500/35";
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          ...
          <textarea
            ...
            name="details"
            rows={4}
            className="w-full rounded-xl border border-[var(--border)] bg-[var(--background-subtle)] px-4 py-3 text-sm text-[var(--foreground)] outline-none transition-colors placeholder:text-[var(--muted)] focus-visible:border-brand-500 focus-visible:ring-2 focus-visible:ring-brand-500/35"
