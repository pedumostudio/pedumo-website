...
export function AuthForm({ mode }: { mode: "login" | "register" }) {
  ...
  const inputClass =
    "h-11 w-full rounded-xl border border-[var(--border)] bg-[var(--background-subtle)] px-4 text-sm outline-none transition-colors placeholder:text-[var(--muted)] focus-visible:border-brand-500 focus-visible:ring-2 focus-visible:ring-brand-500/35";
