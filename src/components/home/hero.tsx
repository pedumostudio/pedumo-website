...
function HeroViewport() {
  ...
  return (
    <div className="relative" aria-hidden role="presentation">
      {/* Outer frame with hairline + corner ticks — decorative product illustration */}
      <div className="relative overflow-hidden rounded-2xl border border-[var(--border-strong)] bg-black shadow-[0_60px_140px_-50px_rgba(33,64,232,0.55)]">
        {/* Top chrome */}
        ...
        >
          {/* Self-contained engineering backdrop — no external asset, no CLS */}
          <div
            className="absolute inset-0"
            style={{
              background:
                "radial-gradient(ellipse 90% 70% at 50% 20%, #10204d 0%, #070c1c 55%, #05070f 100%)",
            }}
          />
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(to right, rgba(122,154,255,0.08) 1px, transparent 1px), linear-gradient(to bottom, rgba(122,154,255,0.08) 1px, transparent 1px)",
              backgroundSize: "40px 40px",
              maskImage:
                "radial-gradient(ellipse 80% 80% at 50% 30%, #000 30%, transparent 90%)",
              WebkitMaskImage:
                "radial-gradient(ellipse 80% 80% at 50% 30%, #000 30%, transparent 90%)",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle 180px at var(--mx) var(--my), rgba(47,225,193,0.35), transparent 70%)",
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs font-semibold">Security by default</p>
            <p className="text-[11px] text-[var(--muted)]">OWASP ASVS-aligned reviews</p>
          </div>
        </div>
        <div className="mt-3 flex items-end justify-between">
          ...
          <span className="text-[11px] text-[var(--muted)]">every engagement</span>
        </div>
      </motion.div>
  ...
  return (
    <section className="relative overflow-hidden pb-20 pt-14 sm:pt-20">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 70% 10%, rgba(33,64,232,0.18), transparent 60%), radial-gradient(ellipse 50% 40% at 10% 80%, rgba(47,225,193,0.12), transparent 60%)",
        }}
      />
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-14 px-5 sm:px-8 lg:grid-cols-12 lg:items-center lg:gap-10">
        ...
        <div className="lg:col-span-7">
          ...
          >
            ...
            <span className="font-mono text-[11px] text-[var(--muted)]">Est. for the AI era</span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="mt-6 text-[2.6rem] font-medium leading-[1.02] tracking-[-0.02em] sm:text-6xl md:text-[4.25rem] lg:text-[4.75rem]"
          >
            Engineering{" "}
