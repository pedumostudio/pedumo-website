...
export const changelog: ChangelogEntry[] = [
  {
    version: "4.3",
    date: "2026-04-08",
    title: "Design system refresh and typography unification",
    kind: "Improvement",
    changes: [
      "Unified the site on a single Inter type system with a refined enterprise scale.",
      "Consolidated color, elevation, radius and motion into consistent design tokens.",
      "Clarified illustrative product interfaces so they are never presented as live metrics.",
      "Tightened accessibility: reduced-motion handling, focus states and heading rhythm.",
    ],
  },
  {
    version: "4.2",
  ...
  },
  {
    ...
    kind: "Release",
    changes: [
      "Rebuilt the homepage as an editorial, asymmetric layout with an illustrative product interface.",
      "Introduced a refined display typography treatment with a distinct technical mono accent.",
      "Shipped CSP, rate limiting, input sanitization and Cloudflare Workers compatibility.",
    ],
  },
  {
    version: "3.2",
